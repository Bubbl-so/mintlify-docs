...
<Tabs>
  ...
  <Tab title="Android Scanner">
    ...
    - Find the Scanner Code inside the Scanner Settings in iOS App, or Web Dashboard and share the Android Scanner code with the person who will be scanning tickets, this is the only way for them to scan.
