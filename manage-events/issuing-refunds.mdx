...
<Tabs>
  <Tab title="Organizers">
    ...
    <Tip>
      Issuing a refund is often less expensive than disputing a chargeback. Stripe may charge dispute fees and side with the customer unless strong evidence is provided.
    </Tip>
