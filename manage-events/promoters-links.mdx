...
<Tabs>
  <Tab title="Promoters">
    ...
    Promoters can monitor their sales performance directly in the app.

    #### Permission-Based Access

    Decide what each promoter can do:

    - View their sales only
    - Add guests to the guest list (optional)
    - Manage sub-promoters, promo codes, or gift tickets
