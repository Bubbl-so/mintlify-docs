...
Stripe charges a **\$15 dispute fee** for every case opened.\
This fee is charged **only if you choose to fight** the dispute, regardless of outcome.

### Possible Outcomes

- **Won:**\
  The bank rules in your favor. The funds are returned automatically, and Bubbl reimburses the \$15 fee.
- **Lost:**\
